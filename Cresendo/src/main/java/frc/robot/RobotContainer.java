...
public class RobotContainer {
    ...
    private final IntakeElevator s_Elevator = new IntakeElevator();
    private final Intakes s_Intakes = new Intakes(s_Elevator);
    ...
    public RobotContainer() {
        ...
        // named commands
        NamedCommands.registerCommand("Apriltags", AprilTagCommand.UpdateVision(drivetrain));
