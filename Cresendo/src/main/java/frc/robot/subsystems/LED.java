...
public class LED extends SubsystemBase {
  ...
  /**
   * There are 3 dials on the blinkin, and each dial controls something. The brightness dial
   * controls brightness on normal operation mode. In setup mode the color dials control color one
   * and color two.
   */
  ...
  /** Make the leds go neutral Have go orange when robot signal light indicator is on. */
