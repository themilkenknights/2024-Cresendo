...
public class Climb extends PIDSubsystem {
  ...
  private MechanismLigament2d rooLigament2d =
      mech.getRoot("root", 0.4, 0.1).append(new MechanismLigament2d("climb", 160, 90));
  ...
  private final ElevatorSim m_elevatorSim =
      new ElevatorSim(0.02, 0.8, DCMotor.getFalcon500(1).withReduction(reduction), 0, 80, true, 0);
  ...
  public Command AutoZero() {
    final ParallelCommandGroup zCommand =
  ...
  public void initSendable(SendableBuilder builder) {
    Shuffleboard.getTab("Climb").add(m_controller);
    Shuffleboard.getTab("Climb").add(locker);
    Shuffleboard.getTab("Climb").add("lock", lockClimb());

    Shuffleboard.getTab("Climb").add("unlock", unlockClimb());
    Shuffleboard.getTab("Climb").add("top", goToClimberPosition(Positions.TOP));
    Shuffleboard.getTab("Climb").add("bottom", goToClimberPosition(Positions.BOTTOM));
    Shuffleboard.getTab("Climb").add("Motor", climber);
    Shuffleboard.getTab("Climb").add("Climb", mech);
  }
